  ...
  extensions: {
    ...
    codegen: {
      ...
      generates: {
        ...
        // graphql operation are queries, mutations, and subscriptions we write in our code to communicate with the GraphQl API
        "src/graphql/types.ts": {
          // preset is a plugin that is used to generate typescript types from GraphQL operation
          ...
          preset: "import-types",
          // document is used to define the path of the files that contain GraphQL operations
